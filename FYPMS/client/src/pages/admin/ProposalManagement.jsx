...
import { Upload, Download, FileText, TrendingUp, Users, Clock, CheckCircle, XCircle, Trash2, RefreshCw, File, Calendar } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 border-b border-gray-200">
          <nav className="flex gap-4">
            {['overview', 'proposals', 'templates', 'defense'].map((tab) => (
              <button
                key={tab}
              ...
              >
                {tab === 'defense' ? 'Proposal Defense' : tab.charAt(0).toUpperCase() + tab.slice(1)}
              </button>
            ))}
          </nav>
        </div>
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        onClick={() => confirmDeleteProposal(proposal.id)}
      ...
      >
        <div className="p-4">
          <p className="text-gray-700 mb-6">
            Are you sure you want to permanently delete this proposal? This will remove the proposal, group members, activity logs, and any uploaded PDF.
          </p>
          <div className="flex justify-end gap-3">
            ...
            <Button variant="danger" onClick={handleDeleteProposal} disabled={deletingProposal}>
